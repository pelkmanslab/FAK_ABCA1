...
%inputtypeVAR03 = popupmenu
    ...
    if ObjectCount > 0
        ...
        for Object = 1:ObjectCount
           ...
           for Pixel = 1:PixelCount
               ...
               GPimage(props(Object).PixelIdxList(Pixel)) = GPvaluePerPixel(Pixel);
           ...
           GPvaluePerObject(Object) = mean(GPvaluePerPixel);    
    ...
    GPimage = (GPimage + 1);
    GPimage = (GPimage / 2);
    matRescaled = (TotalGPvaluePerPixel + 1)/2;
    GPimage = (GPimage - min(matRescaled));
    GPimage = (GPimage/max(matRescaled));
